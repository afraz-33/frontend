  ...
  return (
    <>
      ...
      <div className="container mx-auto p-4">
            ...
            return (
              <div
                ...
                onClick={() => {
                  ...
                  router.push(
                    `/view-product?document_id=${product.documentId}`
                  );
                }}
              >
                {imageUrl ? (
        ...
        {/* Contacts Grid */}
        <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mt-12 mb-8">
          {t("contacts")}
        </h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
          {contacts.map((contact, index) => (
            ...
            >
              ...
              <p className="text-sm sm:text-lg text-white">
                <strong>{t("residence")}:</strong> {contact.residence}
              </p>
              <p className="text-sm sm:text-lg text-white">
                <strong>{t("reason")}:</strong> {contact.reason}
              </p>
              <p className="text-sm sm:text-lg text-white">
                <strong>{t("preferredContact")}:</strong> {contact.contact_pref}
              </p>
              <p className="text-sm sm:text-lg text-white">
                <strong>{t("contactTime")}:</strong> {contact.contact_time}
              </p>
              <p className="text-sm sm:text-lg text-white">
                <strong>{t("funeralPreference")}:</strong>{" "}
                {contact.funeral_pref}
              </p>
              <p className="text-sm sm:text-lg text-white">
                <strong>{t("comment")}:</strong> {contact.comment}
              </p>
            </div>
          ))}
        </div>
